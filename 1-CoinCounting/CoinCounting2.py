...
def images(file):
    ...
    contours = cv2.HoughCircles(gray_blur, cv2.HOUGH_GRADIENT, 1, 50, param1 = 30, param2 = 38, minRadius = 0, maxRadius =0 )
    ...
    for contour in contours[0,:]:
        ...
        cv2.circle(img_resized, (contour[0], contour[1]), contour[2], (0, 0, 255),5)
        cv2.circle(img_resized, (contour[0], contour[1]), 2, (0,255,0), 1)
        cv2.putText(img_resized, 'Coin-' + str(count), (contour[0]-80,contour[1]-70), cv2.FONT_ITALIC,1.1,(120,200,0),3)
        count +=1
